...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.quad = new MyQuad(this,this.quadTexCoords);
        ...
        this.customSide = new CGFappearance(this);

        this.customSide.setAmbient(1, 1, 1, 1.0);
        this.customSide.setDiffuse(1, 1, 1, 1.0);
        this.customSide.setSpecular(1, 1, 1, 1.0);
        this.customSide.setShininess(10.0);
        this.customSide.loadTexture('images/mineSide.png');
        this.customSide.setTextureWrap('REPEAT', 'REPEAT');

        this.customTop = new CGFappearance(this);

        this.customTop.setAmbient(1, 1, 1, 1.0);
        this.customTop.setDiffuse(1, 1, 1, 1.0);
        this.customTop.setSpecular(1, 1, 1, 1.0);
        this.customTop.setShininess(10.0);
        this.customTop.loadTexture('images/mineTop.png');
        this.customTop.setTextureWrap('REPEAT', 'REPEAT');

        this.customBottom = new CGFappearance(this);

        this.customBottom.setAmbient(1, 1, 1, 1.0);
        this.customBottom.setDiffuse(1, 1, 1, 1.0);
        this.customBottom.setSpecular(1, 1, 1, 1.0);
        this.customBottom.setShininess(10.0);
        this.customBottom.loadTexture('images/mineBottom.png');
        this.customBottom.setTextureWrap('REPEAT', 'REPEAT');

        //------

        this.cube = new MyUnitCubeQuad(this, this.customSide, this.customSide, this.customSide, this.customSide, this.customTop, this.customBottom);
