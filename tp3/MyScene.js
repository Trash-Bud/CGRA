...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.customWood = new CGFappearance(this);

        this.customWood.setAmbient(0.30, 0.14, 0.07, 1.0);
        this.customWood.setDiffuse(0.5, 0.33, 0.26, 1.0);
        this.customWood.setSpecular(0.1, 0.1, 0.1, 1.0);
        this.customWood.setShininess(10.0);
    
        this.materials = [this.material1, this.material2, this.material3, this.customMaterial,this.customWood];

        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Custom': 3, 'Custom wood' : 4, 'Custom tangram' : 5 };
    }
    display() {
        ...
        if (this.selectedMaterial != 5) this.materials[this.selectedMaterial].apply();
